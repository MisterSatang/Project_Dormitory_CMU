    ...
    <>
      ...
      <div className="col-12 p-0 m-0">
        ...
        <div className="dropdown d-flex justify-content-center">
          <button
            className="btn btn-secondary  dropdown-toggle col-4"
            type="button"
          ...
          <ul className="dropdown-menu">
            <Link to="/Price_male">
              <button className="joinBtn dropdown-item " type="button">
                หอพักนักศึกษาชายมหาวิทยาลัยเชียงใหม่
              </button>
            </Link>
            <Link to="/Price_female">
              <button className="joinBtn dropdown-item" type="button">
                หอพักนักศึกษาหญิงมหาวิทยาลัยเชียงใหม่
              </button>
            </Link>
          </ul>
        </div>
            ...
            <div className="card shadow mb-4">
              <div className="card-body p-5">
                <h4 className="mb-4 text-purple ">
                  <strong>หอพักนักศึกษาชายอาคาร 3 และอาคาร 4</strong>
                </h4>
                <ul className="list-unstyled">
                  <h6 className="mb-2 ">
                    <strong>ค่าบำรุงหอพักนักศึกษา</strong>{" "}
                  </h6>
                  <li className="mb-2">
