                    ...
                    <div class="col-lg-7 mx-auto">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body p-5">
                                <h4 class="mb-4 text-purple "><strong>หอพักนักศึกษาชายอาคาร 1 (CD) และอาคาร 2 (GH)</strong></h4>
                                <ul class="list-unstyled">
                                    <h6 class="mb-2 "><strong>ค่าบำรุงหอพักนักศึกษา</strong> </h6>
                                    <li class="mb-2">- ค่าบำรุงหอพัก คนละ 2,500 บาท/เดือน.</li>
                                    <li class="mb-2">- ค่าบำรุงหอพัก (แบบเหมาห้อง) 5,000 บาท/เดือน</li>
                                    <h6 class="mb-2"><strong>ค่าประกันของเสียหาย</strong> </h6>
                                    <li class="mb-2">- คนละ 2,500 บาท</li>
                                    <li class="mb-2">- คนละ 2,500 บาท (แบบเหมาห้อง)</li>
                                    <h6 class="mb-2"><strong>ค่าทำความสะอาด</strong> </h6>
                                    <li class="mb-2">- ค่าทำความสะอาดห้องพัก คนละ 100 บาท</li>
                                    <li class="mb-2">- ค่าทำความสะอาดห้องพัก คนละ 100 บาท (แบบเหมาห้อง)</li>
                                    ...
                                    <li class="mb-2">- 5,100 บาท/คน/เดือน</li>
                                    <li class="mb-2">- 7,600 บาท/คน/เดือน (แบบเหมาห้อง)</li>
                                    <li class="mb-2"><strong>สำหรับเดือนถัดไป</strong></li>
                                    <li class="mb-2">- 2,500 บาท/คน/เดือน พร้อมค่าไฟฟ้าและค่าน้ำประปาตามมิเตอร์</li>
                                    <li class="mb-2">- 5,000 บาท/คน/เดือน (แบบเหมาห้อง) พร้อมค่าไฟฟ้าและค่าน้ำประปาตามมิเตอร์</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-body p-5">
                                <h4 class="mb-4 text-purple "><strong>หอพักนักศึกษาชายอาคาร 3</strong></h4>
                                <ul class="list-unstyled">
                                    <h6 class="mb-2 "><strong>ค่าบำรุงหอพักนักศึกษา</strong> </h6>
