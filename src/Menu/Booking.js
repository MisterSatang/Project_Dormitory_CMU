            ...
            <div className="col-xl-3 col-lg-4 col-md-5 col-12 col-sm-6 pe-4 ps-0">
                <div className="bg-white shadow rounded-top-4">
                    <div className="pt-4 px-3  bg-light rounded-top-4 border-bottom border-1 border-3">
                        <div className="d-flex align-items-center"><img src="img_dormitory/imageStudent/01.jpg" alt="image" className="mr-3 profile-student shadow-sm rounded-3" />
                        <div className="ms-3">
                            <div className="d-inline-flex fs-5 m-0 me-2">สตางค์</div>
                            <div className="d-inline-flex fs-5 m-0">บุตรสัย</div>
                            <div className="font-weight-light text-muted mb-0">คณะ ศิลปะ สื่อ เทคโนโลยี</div>
                            <div className="font-weight-light text-muted mb-0">สาขา DII</div>
                        </div>
                        </div>
                ...
                <div className="p-1 bg-light rounded-r-4 shadow-sm mb-4">
                  ...
                  <input type="search" placeholder="ค้นหา : หมายเลขห้อง ?" aria-describedby="button-addon1" className="form-control border-0 bg-light" />
                    <div className="input-group-append">
                      <button id="button-addon1" type="submit" className="btn btn-link text-dark"><i className="bi bi-search"></i></button>
                    </div>
                  </div>
                </div>
                <p className="text-gray font-weight-bold text-uppercase px-3 small pb-3 mb-0"><i className="bi bi-funnel me-1"></i>Filter</p>
                ...
                <ul className="nav flex-column bg-light mb-0 px-4 py-3 rounded-ts-4">
                  ...
                  <FilterSexBuilding setSexBuilding={setSexBuilding} dormitories={dormitories} />
                    ...
                    <li className="nav-item">
                      <div className="mb-1">จำนวนคนว่าง</div>
