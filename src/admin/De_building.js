                ...
                <div className='row'>
                    ...
                    <div className='col-9 d-flex justify-content-center'>
                        <div className="row ms-3">
                            <div className="col-11 text-center m-4"><h4>ลบอาคารหอพักนักศึกษา มหาวิทยาลัยเชียงใหม่</h4></div>
                            ...
                            <div className="col-8 text-start">
                                <div className="col-10 ">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input className="form-control" type="text" placeholder="เช่น 108" aria-label="default input example" />
                                    </div>
