            ...
            <div className='container-fluid p-0 bg-admin'>
                <div className='row'>
                    ...
                    <div className='bg-lights col'>
                        <div className="row h-100vh col-12">
                            ...
                            <div className="text-color col-12 d-flex justify-content-center"><h3><strong>ยินดีต้อนรับเข้าสู่ระบบ Admin Dormitory CMU</strong></h3></div>
                        </div>
                    </div>
                </div>
            </div>
