...
export default function Navbar() {
  return (
    <>  
    <div className="container fixed-top border-0 rounded rounded-4 bg-nav mt-2">
        <nav className="navbar navbar-expand-lg ">
            <div className="container-fluid">
                <a className="navbar-brand" href="#"><div className="text-purple">หอพักนักศึกษา มช</div></a>
